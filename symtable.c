...
LAB TITLE: Lab 9
DATE:      April 18, 2023
PURPOSE:   Source file for a compiler's symbol table.
...
// PRE:   Assume one up global variable LTemp
// POST:  Returns string with the format _L%d and increments the global vairbal
// USAGE:   creates a label for string printing in emit.c
